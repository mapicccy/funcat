...
while i >= 0:
    ...
    direction = stat.loc[stat['ts_code'] == sym]['dir'].tolist()
    ...
    filename = "/home/ec2-user/public/futures/{}.html".format(symfull)

    data = KChartData(symfull, df, freq='S', precision=2)
    chart = data.plot(area=['V'], klines=['ma5','ma13'])
    chart.render(filename)

    handled.append(sym)
    print(symfull, date, filename, len(handled))
